...
<div class="col-sm-12 col-md-12 col-lg-12">
  <form method="post" action="{{ route('customers.loadcentersavings') }}">
                        {{ csrf_field() }}
...
<div class="col-sm-2 col-md-2 col-lg-2">
    ...
    <div class="panel-heading">Savings withdraw
    ...
    <div class="panel-body">
      ...
      <table class="table">
                     ...
                     <tbody>
                       ...
                       <form method="post" action="{{ route('customers.withdraw') }}">
                                             {{ csrf_field() }}
                         ...
                         <tr>
                           ...
                           <td>  <a href="/customers/{{ $customer->customer_id }}" >{{ $customer->customer_nic}}</a></td>
                            ...
                            <td>  <a href="/customers/{{ $customer->customer_id }}" >{{ $customer->customer_savings}}</a></td>

                            <td> <input required class="form-control" id="payment" name="amount"  type="number" step="0.01" min="0" max="{{$customer->customer_savings }}"value="0.00" aria-describedby="amountHelp" placeholder=" "></td>
